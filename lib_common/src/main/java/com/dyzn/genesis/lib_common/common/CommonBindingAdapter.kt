...
import com.dyzn.genesis.lib_common.widget.ProgressView
...
fun setProgressViewSchedule(view:ProgressView,schedule:Int){
    view.setSchedule(schedule)
}
@BindingAdapter("progressHintText")
fun setProgressViewHintText(view:ProgressView,hintText:String?){
