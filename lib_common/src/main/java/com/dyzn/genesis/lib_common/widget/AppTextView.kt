...
open class AppTextView @JvmOverloads constructor(
    ...
    init {
        ...
        leftBottomRadius = ta.getDimensionPixelSize(R.styleable.AppTextView_bg_left_bottom_radius, 0)
        rightTopRadius = ta.getDimensionPixelSize(R.styleable.AppTextView_bg_right_top_radius, 0)
        rightBottomRadius = ta.getDimensionPixelSize(R.styleable.AppTextView_bg_right_bottom_radius, 0)
