...
import com.dyzn.genesis.lib_common.databinding.BaseAppTitleBinding
import com.dyzn.genesis.lib_common.type.DefaultPageType
...
class AppTitle @JvmOverloads constructor(
    ...
    private var binding: BaseAppTitleBinding =
        BaseAppTitleBinding.inflate(LayoutInflater.from(context), this, true)
    ...
    init {
        ...
        if (noTitle) {
            ...
            binding.tvTitle.setBackgroundColor(titleBackgroundColor)
            if (noBackIcon) {
                binding .ivBack.visibility = GONE
            } else {
