...
import com.dyzn.genesis.lib_common.network.errorhandler.CustomException
import com.dyzn.genesis.lib_common.network.errorhandler.ExceptionHandle
import com.dyzn.genesis.lib_common.util.LogUtil
import kotlinx.coroutines.*

/**
 *@author YLC-D
 *@create on 2020/11/10 16
 *说明: 数据请求基类
 */
